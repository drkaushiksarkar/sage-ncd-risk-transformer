"""Metrics collection and reporting for sage-ncd-risk-transformer."""
import time
import logging
...
class SageNcdRiskTransformerMetrics:
    """Collect, aggregate, and report metrics for sage-ncd-risk-transformer operations."""

    def __init__(self, namespace: str = "sage-ncd-risk-transformer"):
